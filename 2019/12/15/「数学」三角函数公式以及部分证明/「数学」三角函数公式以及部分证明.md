...
泰勒展开：$\sin x=\sum_{n=0}^{\infty} \frac{(-1)^{n}}{(2 n+1) !} x^{2 n+1} \quad x \in \mathbb R$

#### 余弦：

$$\cos A = \frac{b}{c}$$

泰勒展开：$\cos x=\sum_{n=0}^{\infty} \frac{(-1)^{n}}{(2 n) !} x^{2 n} \quad x \in \mathbb R$

#### 正切：

$$\tan A = \frac{a}{b}$$

泰勒展开：$\tan x=\sum_{n=1}^{\infty} \frac{B_{2 n}(-4)^{n}\left(1-4^{n}\right)}{(2 n) !} x^{2 n-1} \quad x \in \left(-\frac{\pi}{2},\frac{\pi}{2}\right)$
...
泰勒展开：$\sec x=\sum_{n=0}^{\infty} \frac{(-1)^{n} E_{2 n}}{(2 n) !} x^{2 n} \quad x \in \left(-\frac{\pi}{2},\frac{\pi}{2}\right)$
